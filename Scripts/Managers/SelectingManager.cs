...
public class SelectingManager : ManagerSingletonBase<SelectingManager>, IGameEvents
{
    ...
    private void CheckSelection(Touch touch, int hits)
    {
        ...
        Plane terrainPlane = MapsManager.Instance.CurrentMap.Terrain.XZPlane;
        ...
        else
        {
            ...
            // Brak obiektow pod myszka sprawdzamy miesce styku z gruntem.
            terrainPlane.Raycast(_reusableRaycast, out float distance);
            touchWorldPosition = _reusableRaycast.GetPoint(distance);
    ...
    public override void AttachEvents()
    {
        ...
        GameplayEvents.Instance.OnLavaStarted += OnLavaStartedHandler;
    }
